...
parameter_map = Dict([
    ...
    car.front_suspension.inboard.heave_strut.spring.c => front.setup.heave.stiffness,
    car.front_suspension.inboard.heave_strut.damper.force_map.independent_var => VehicleComponents.damper_map(data.dampers, front.setup.heave.damper).velocity,
    car.front_suspension.inboard.heave_strut.damper.force_map.data => VehicleComponents.damper_map(data.dampers, front.setup.heave.damper).force,
    car.front_suspension.inboard.heave_strut.spring.s_unstretched => front.setup.heave.s_unstretched,
    car.front_suspension.inboard.heave_strut.spring.perch_height => front.setup.heave.perch_height,
    car.front_suspension.inboard.roll_strut.spring.c => front.setup.roll.stiffness,
    car.front_suspension.inboard.roll_strut.damper.force_map.independent_var => VehicleComponents.damper_map(data.dampers, front.setup.roll.damper).velocity,
    car.front_suspension.inboard.roll_strut.damper.force_map.data => VehicleComponents.damper_map(data.dampers, front.setup.roll.damper).force,
    car.front_suspension.inboard.roll_strut.spring.s_neutral => front.setup.roll.s_neutral,
    car.front_suspension.inboard.roll_strut.spring.preload_travel => front.setup.roll.preload_travel,
    ...
    car.rear_suspension.inboard.heave_strut.spring.c => rear.setup.heave.stiffness,
    car.rear_suspension.inboard.heave_strut.damper.force_map.independent_var => VehicleComponents.damper_map(data.dampers, rear.setup.heave.damper).velocity,
    car.rear_suspension.inboard.heave_strut.damper.force_map.data => VehicleComponents.damper_map(data.dampers, rear.setup.heave.damper).force,
    car.rear_suspension.inboard.heave_strut.spring.s_unstretched => rear.setup.heave.s_unstretched,
    car.rear_suspension.inboard.heave_strut.spring.perch_height => rear.setup.heave.perch_height,
    car.rear_suspension.inboard.roll_strut.spring.c => rear.setup.roll.stiffness,
    car.rear_suspension.inboard.roll_strut.damper.force_map.independent_var => VehicleComponents.damper_map(data.dampers, rear.setup.roll.damper).velocity,
    car.rear_suspension.inboard.roll_strut.damper.force_map.data => VehicleComponents.damper_map(data.dampers, rear.setup.roll.damper).force,
    car.rear_suspension.inboard.roll_strut.spring.s_neutral => rear.setup.roll.s_neutral,
    car.rear_suspension.inboard.roll_strut.spring.preload_travel => rear.setup.roll.preload_travel,
...
plot_spring_forces = Plots.plot(
    sol;
    idxs=[car.front_suspension.inboard.heave_strut.f, car.front_suspension.inboard.roll_strut.f],
    labels=["heave" "roll"],
    linewidth=2,
    xlabel="t [s]",
