...
@doc Markdown.doc"""
   LinkageTestRig(; name, is_left, wheel_center, stroke, freq)
...
| `freq`         |                          | Hz  |   0.5 |
"""
@component function LinkageTestRig(; name = nothing, is_left=true, wheel_center=[Float64(0.0), 0.6, 0.23], stroke=0.0254, freq=0.5, kwargs...)
